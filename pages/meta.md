...
### Zdrojový kód
Webová stránka je v neustálém vývoji a její zdrojový kód je volně dostupný na [GitHubu](https://github.com/Meziklassociation/meziklasi) pod licencí [AGPLv3](https://github.com/Meziklassociation/meziklasi/blob/master/LICENSE). Budeme moc rádi, když nás podpoříte hvězdičkou ⭐!
